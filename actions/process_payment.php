...
curl_setopt_array($curl, array(
  ...
  CURLOPT_HTTPHEADER => array(
    "Authorization: Bearer sk_test_497a3a223893acf3ff8ecfd4dce1158b2fc9b088",
...
if (isset($decodedResponse->data->status) && $decodedResponse->data->status === 'success') {
  ...
  //insert into order
  $order = insert_order_ctr($cid, $invoice, $status);
  ...
  if ($add_pay) {
    ...
    header("Location: ../view/checkout.php?payment=success");
  } else {
    //redirects you to the payment failed page
    header("Location: ../view/checkout.php?payment=failed");
  }
}
