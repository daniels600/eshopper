...
<body>
    ...
    $all_products = select_all_product_ctr();
    $all_categories = getAllCategories_ctr();

    showItemAddedToCartAlert();
                    ...
                    <div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
                        ...
                        if (isset($all_categories)) {
                            foreach ($all_categories as $category) {
                                echo '<a href="home.php?cat_id=' . $category['cat_id'] . '" class="nav-item nav-link">' . $category['cat_name'] . '</a>';
                            }
                        } else {
                        ...
                        <div class="carousel-item active" style="height: 410px;">
                            ...
                            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div class="p-3" style="max-width: 700px;">
                                    ...
                                    <h3 class="display-4 text-white font-weight-semi-bold mb-4">Bernice Apparel & Clothing</h3>
                    ...
                    <div class="card product-item border-0 mb-4">
                        ...
                        <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                            ...
                            <div class="d-flex justify-content-center">
                                <h6>GH₵ ' . $product['product_price'] . '</h6>
                            </div>
                        </div>
                        <div class="card-footer d-flex justify-content-between bg-light border">
                            <a href="single_product.php?p_id=' . $product['product_id'] . '" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>View Detail</a>
                            <a href="../actions/add_to_cart.php?pid=' . $product['product_id'] . '" class="btn btn-sm text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Add To Cart</a>
                        </div>
                    </div>
                </div>';
                }
    ...
    <div class="container-fluid bg-secondary text-dark mt-5 pt-5">
        <div class="row px-xl-5 pt-5">
            <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
                <a href="" class="text-decoration-none">
                    <h1 class="mb-4 display-5 font-weight-semi-bold"><span class="text-primary font-weight-bold border border-white px-3 mr-1">B</span>ernice Apparel</h1>
                </a>
