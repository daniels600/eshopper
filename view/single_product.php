...
<body>
    ...
    if ($_GET['p_id']) {
        $product = select_one_product_ctr($_GET['p_id']);
    }
    ...
    <div class="container-fluid py-5">
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="<?php echo $product['product_image']; ?>" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 pb-5">
                <h3 class="font-weight-semi-bold"><?php echo $product['product_title']; ?></h3>
                ...
                <h3 class="font-weight-semi-bold mb-4">₵ <?php echo $product['product_price']; ?></h3>
                <p class="mb-4"> <?php echo $product['product_desc']; ?></p>


                <div class="d-flex align-items-center mb-4 pt-2">
                    <a href="<?php echo "../actions/add_to_cart.php?pid={$product['product_id']}" ?> "><button class="btn btn-primary px-3"><i class="fa fa-shopping-cart mr-1"></i> Add To Cart</button></a>
                </div>
