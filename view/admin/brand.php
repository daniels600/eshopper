...
<body >
    ...
    <a href="../view/home.php" class="btn btn-dark text-light" style="margin-left:600px;" >Home</a>
        ...
        <div style=" margin-left:500px; margin-right:500px;">
            ...
            <form method="POST" action="../functions/add_brand.php" onsubmit="required()" name="form1">
                  ...
                  if ($brandlist) {
                    ...
                    foreach($brandlist as $one_item){
                        ...
                        <td>
                            ...
                            <a href='../functions/add_brand.php?delete=$brandID' class='btn btn-dark'>Delete</a>
                        </td>
                    </tr>
                        ";
