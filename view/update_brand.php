...
<body>
    ...
    <div style=" margin-left:500px; margin-right:500px;">
        ...
        <form method="POST" action="../actions/brand_action.php" onsubmit="required()" name="form1">
            ...
            <input name="bname" type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $old_bname['brand_name']; ?>">
            <br>

            <input name="b_id" type="hidden" class="form-control" id="exampleInputEmail1" value="<?php echo $old_bname['brand_id']; ?>">
