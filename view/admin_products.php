...
<body>
    ...
    <div style="font-size: 40px; margin-left:500px; margin-bottom:50px;">Product list
        <a href="../index.php" class="btn btn-dark text-light" style="margin-left:610px;">Home</a>
    </div>
  ...
  margin-right: auto;text-align: center">
        <div class="row">
            <button style="margin-right: 80px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="fa-solid fa-plus"></i> Add Product</button>
            <button style="margin-right: 80px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="fa-solid fa-plus"></i> Add Category</button>
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="fa-solid fa-plus"></i> Add Brand</button>
            ...
            <table class="table">
                ...
                if ($productlist) {
                    ...
                    foreach ($productlist as $one_item) {
                        ...
                        echo " <tr>
                        <td>$productID</td>
                        <td><img src='$product_img' alt='Product img'></td>
                        <td>$product_title</td>
                        <td>
