...
<body>
  ...
  margin-right: auto;text-align: center">
        <div class="row">
            <button style="margin-right: 80px; background-color: #4F6D7A; color: white" type="button" class="btn" data-toggle="modal" data-target="#addCategoryModal"><i class="fa-solid fa-plus"></i> Add Category</button>
        </div>
            ...
            <table class="table table-bordered">
                ...
                if ($cat_list) {
                    ...
                    foreach ($cat_list as $one_item) {
                        ...
                        <td>$categoryName</td>
                        <td>
                            <a href='update_category.php?edit=$categoryID'  '><button class='btn btn-success' type='button' ><i class='fa-solid fa-pen-to-square'></i>  edit
                            </button></a>
                            <a href='../actions/category_action.php?delete=$categoryID' class='btn btn-danger'> <i class='fa-solid fa-trash-can'></i>  Delete</a>
                        </td>
                    </tr>
                        ";
                    }
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="../actions/category_action.php" onsubmit="required()" name="form1">
