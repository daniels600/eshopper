...
<body>
    ...
    <div style=" margin-left:500px; margin-right:500px;">
        ...
        <form method="POST" action="../actions/category_action.php" onsubmit="required()" name="form1">
            ...
            <input name="cat_name" type="text" class="form-control" id="exampleInputEmail1" value="<?php echo $old_cname['cat_name']; ?>">
            <br>
            <input name="cat_id" type="hidden" class="form-control" value="<?php echo $old_cname['cat_id']; ?>">
